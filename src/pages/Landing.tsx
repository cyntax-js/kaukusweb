...
function Compliance() {
  ...
  const complianceCards = [
    {
      title: t("landing.kycAmlReadiness"),
      txt: t("landing.kycAmlDescription"),
    },
    {
      title: t("landing.auditFriendlyReporting"),
      txt: t("landing.auditFriendlyDescription"),
    },
    {
      title: t("landing.transparentSettlementTitle"),
      txt: t("landing.transparentSettlementDescription"),
    },
    {
      title: t("landing.institutionalControlsTitle"),
      txt: t("landing.institutionalControlsDescription"),
    },
  ];
        ...
        <div className="max-w-[1000px] mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              {t("landing.whatIsContiSX")}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {t("landing.whatIsDescription")}
            </p>
          </div>
          <FeaturesGrid />
        </div>
          ...
          <div className="text-left mb-12 flex items-center justify-between mb-[60px]">
            <div className="flex flex-col">
              <h2 className="text-2xl md:text-3xl font-bold mb-2 text-[#000]">
                {t("landing.complianceAndGovernance")}
              </h2>
              <p className="text-[#000]/50 max-w-2xl mb-4">
                {t("landing.complianceDescription")}
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Button
            ...
            <div className="mt-16 border-[0.5px] border-white rounded-[15px] p-5 flex items-center justify-between">
              <div>
                <p className="text-md font-medium">
                  {t("landing.stillHaveQuestion")}
                </p>
                <p className="mt-2 text-white/70 text-sm">
                  {t("landing.contactIfQuestions")}
                </p>
              </div>
              <Button
                size="lg"
