...
export function UserProfileDrawer({
  ...
  const trades = useMemo(
    () => (user ? generateMockTrades(user.id) : []),
    [user?.id]
  );
  ...
  const getTierBadge = (tier?: string) => {
    switch (tier) {
      ...
      case "silver":
        return (
          <Badge className="bg-slate-400/10 text-slate-400 border-slate-400/20">
            Silver
          </Badge>
        );
      default:
          ...
          <ScrollArea className="flex-1 mt-4">
              ...
              <Card className="p-4 space-y-3">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span>
                      +1 (555) {Math.floor(100 + Math.random() * 900)}-
              ...
              <Card className="p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => onStatusChange(user.id, "restricted")}
                  >
            ...
            <TabsContent value="trades" className="mt-0 space-y-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium">
                  Win Rate: {isNaN(winRate) ? "0" : winRate.toFixed(0)}%
                </span>
              </div>
              {trades.map((trade) => (
            ...
            <TabsContent value="activity" className="mt-0 space-y-3">
              {[
                ...
                {
                  action: "Executed buy order: 10 AAPL",
                  time: "3 hours ago",
                  icon: ArrowUpRight,
                },
                { action: "Deposited $5,000", time: "1 day ago", icon: Coins },
                {
                ...
                {
                  action: "Executed sell order: 25 TSLA",
                  time: "3 days ago",
                  icon: ArrowDownRight,
                },
                {
                ...
                },
                {
                  ...
                  time: user.joinedAt.toLocaleDateString(),
                  icon: Calendar,
                },
              ].map((activity, i) => (
                <div
