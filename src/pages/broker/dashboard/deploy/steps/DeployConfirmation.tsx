    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          Review your platform's final appearance. This is exactly how your
          users will see it.
        </p>
      </div>
          ...
          <div>
            ...
            <div className="flex gap-1">
              <div
                ...
                style={{
                  backgroundColor: `hsl(${config.theme.colors.primary})`,
                }}
                title="Primary"
              />
              <div
                className="w-6 h-6 rounded-full border-2 border-background shadow-sm"
                style={{
                  backgroundColor: `hsl(${config.theme.colors.accent})`,
                }}
                title="Accent"
              />
              <div
                className="w-6 h-6 rounded-full border-2 border-background shadow-sm"
                style={{
                  backgroundColor: `hsl(${config.theme.colors.background})`,
                }}
                title="Background"
              />
            </div>
      ...
      <Card className="overflow-hidden">
        ...
        <div
          className={`bg-muted/30 transition-all ${
            previewDevice === "mobile" ? "flex justify-center py-4" : ""
          }`}
        >
          <div
            className={`${
              previewDevice === "mobile"
                ? "w-[375px] rounded-xl overflow-hidden shadow-2xl border"
                : "w-full"
            }`}
          >
            <iframe
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <div onClick={() => setIsConfirmed(!isConfirmed)}>
            ...
            <p className="text-sm text-muted-foreground">
              I've reviewed my platform's appearance and I'm ready to proceed to
              payment.
            </p>
          </div>
        </label>
      ...
      {!isConfirmed && (
        <div className="flex items-start gap-3 text-sm text-muted-foreground bg-muted/50 rounded-lg p-4">
          ...
          <p>
            Please confirm your theme selection above before proceeding. You can
            still go back and make changes.
          </p>
        </div>
      )}
