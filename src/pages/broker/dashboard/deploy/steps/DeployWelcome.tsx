...
export default function DeployWelcome() {
  const { config, setBrokerName, setLogo, setFavicon } =
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">
          Let's Build Your Broker Platform
        </h2>
        <p className="text-muted-foreground max-w-xl mx-auto">
          Set up your platform identity, select services, choose a theme, and go
          live.
        </p>
      </div>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="brokerName" className="text-base font-medium">
                Platform Name
              </Label>
              <Input
                id="brokerName"
        ...
        <Card className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div
                className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer hover:border-primary/50 ${
                  logoPreview ? "border-primary bg-primary/5" : "border-border"
                }`}
