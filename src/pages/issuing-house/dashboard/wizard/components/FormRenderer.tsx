  ...
  const handleSubmit = () => {
    ...
    if (isValid) {
      ...
      const newOffer: CreatedOffer = {
        ...
        description:
          (formValues.useOfProceeds as string) ||
          "New securities offering for capital raising.",
      ...
      toast({
        ...
        description:
          "Your security offering has been submitted for regulatory review.",
      });
      ...
      <div className="flex-1 max-w-3xl">
            ...
            {isPostApproval && submittedOfferId ? (
              ...
              <div className="space-y-6">
                {getVisibleFields(currentStepData.fields).map((field) => (
                  <FieldRenderer
                    key={`${currentStepData.id}-${field.id}`}
                    field={field}
                  />
                ))}
              </div>
        ...
        <div className="sticky bottom-0 mt-6 flex items-center justify-between rounded-lg border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 p-4 shadow-lg">
          ...
          <div className="flex items-center gap-3">
            ...
            ) : isPostApproval ? null : ( // Hide navigation during approval process
              <Button
                type="button"
                onClick={handleNext}
                disabled={isLastStep}
      ...
      <div className="hidden xl:block w-64 shrink-0">
        <div className="sticky top-6 rounded-lg border bg-muted/20 p-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Complete each section with accurate information. Required fields are
