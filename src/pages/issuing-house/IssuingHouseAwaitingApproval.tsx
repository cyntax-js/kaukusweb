...
export default function IssuingHouseAwaitingApproval() {
  const navigate = useNavigate();
  const { status, approvalProgress, application } = useIssuingHouseStore();
        ...
        <Card className="p-8 md:p-12">
            ...
            {isApproved ? (
              <>
                ...
                <p className="text-muted-foreground">
                  Congratulations! Your issuing house has been registered.
                </p>
              </>
            ) : (
              <>
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-chart-4 to-chart-4/70 flex items-center justify-center mx-auto mb-6 animate-pulse-slow">
                ...
                <p className="text-muted-foreground">
                  Your application is being reviewed. This typically takes 5-7 business days.
                </p>
              </>
            )}
          </div>
          ...
          {isApproved ? (
            <Button
              ...
              size="lg"
              onClick={() => navigate("/issuing-house/dashboard")}
            >
              Go to Dashboard
