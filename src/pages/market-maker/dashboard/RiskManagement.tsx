...
export default function RiskManagement() {
  const utilizationColor =
    riskMetrics.utilizationPercent > 80
      ? "text-destructive"
      : riskMetrics.utilizationPercent > 60
      ? "text-chart-4"
      : "text-chart-2";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor and manage trading risk exposure
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4">
            ...
            <Progress
              value={riskMetrics.utilizationPercent}
              className="h-2 mb-2"
            />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <CardContent>
            <p
              className={`text-2xl font-bold ${
                riskMetrics.dailyPnL >= 0 ? "text-chart-2" : "text-destructive"
              }`}
            >
              {riskMetrics.dailyPnL >= 0 ? "+" : ""}
              {formatCurrency(riskMetrics.dailyPnL)}
        ...
        <Card>
          ...
          <CardContent>
            <p
              className={`text-2xl font-bold ${
                riskMetrics.weeklyPnL >= 0 ? "text-chart-2" : "text-destructive"
              }`}
            >
            ...
            <TableBody>
              {dealerInventory.map((position) => {
                ...
                const capitalPercent =
                  (marketValue / riskMetrics.maxPositionSize) * 100;
                const riskLevel =
                  capitalPercent > 15
                    ? "high"
                    : capitalPercent > 10
