...
const faqs = [
  ...
  },
  {
    ...
    a: 'Depending on your plan, users can access Spot trading, Futures & Derivatives, Options, and Private Markets.',
  },
  {
      ...
      <div className="py-20">
        ...
        <section className="container mx-auto px-4 mb-16">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground opacity-0 animate-fade-in stagger-1">
              Choose the plan that fits your needs. All plans include our core trading 
              infrastructure and can be upgraded at any time.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {brokerPlans.map((plan, i) => (
              <Card 
                key={i} 
                className={`p-8 hover-lift relative ${plan.popular ? 'border-primary shadow-glow' : ''}`}
              >
                {plan.popular && (
        ...
        <section className="bg-secondary/30 py-20 mb-20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-4">Trading Products</h2>
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              Select the trading products you want to offer to your users. Each product is priced separately.
            </p>
        ...
        <section className="container mx-auto px-4">
          <Card className="gradient-primary p-12 text-center text-white">
            <h2 className="text-3xl font-bold mb-4">Ready to Launch Your Broker?</h2>
