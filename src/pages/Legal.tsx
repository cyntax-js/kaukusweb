    ...
    content: [
      {
        ...
        text: "By accessing or using Kaukus services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this service.",
      },
      {
        heading: "2. Use License",
        text: "Permission is granted to temporarily access the materials on Kaukus for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.",
      },
      {
      ...
      },
      {
        ...
        text: "While we strive for 99.9% uptime, Kaukus does not guarantee uninterrupted access to our services. Scheduled maintenance will be communicated in advance.",
      },
      {
      ...
      },
      {
        ...
        text: "Kaukus shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of the service.",
      },
    ],
  },
  privacy: {
    ...
    content: [
      {
        ...
        text: "Kaukus operates under regulatory oversight in multiple jurisdictions including SEC (US), FCA (UK), ASIC (Australia), and other regulatory bodies.",
      },
      {
