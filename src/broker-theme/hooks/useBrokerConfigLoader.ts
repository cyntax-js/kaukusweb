 ...
 */
function mapBootstrapToBrokerConfig(bootstrapConfig: BootstrapBrokerConfig): BrokerConfig {
  return {
    ...
    theme: {
      ...
      layout: {
        auth: bootstrapConfig.theme.layout.auth as 'centered' | 'split' | 'image-left',
        dashboard: bootstrapConfig.theme.layout.dashboard as 'sidebar' | 'topnav',
        orderBookPosition: bootstrapConfig.theme.layout.orderBookPosition as 'left' | 'right',
      },
      components: bootstrapConfig.theme.components ? {
        cardStyle: bootstrapConfig.theme.components.cardStyle as 'flat' | 'bordered' | 'elevated',
        buttonSize: bootstrapConfig.theme.components.buttonSize as 'sm' | 'md' | 'lg',
        borderRadius: bootstrapConfig.theme.components.borderRadius as 'none' | 'sm' | 'md' | 'lg' | 'full',
      } : undefined,
    },
