...
const serviceInfo = {
  stock: {
    title: "Stock Trading",
    description:
      "Buy and sell assets at current market prices with instant settlement",
    icon: <TrendingUp className="h-6 w-6" />,
  },
  futures: {
    title: "Futures Trading",
    description: "Trade contracts for future delivery with up to 100x leverage",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-left">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl animate-fade-in stagger-2">
                Access institutional-grade trading infrastructure. Real-time
                data, advanced charting, and lightning-fast execution for
                serious investors.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 animate-fade-in stagger-3">
                <Link to={defaultMarketPath}>
                  <Button
                    size="lg"
                    className="gap-2 gradient-primary hover:opacity-90 transition-opacity text-primary-foreground"
                  >
            ...
            <div className="relative animate-fade-in stagger-3">
              ...
              <div
                className="absolute -bottom-4 -left-4 bg-card rounded-xl border border-border p-3 shadow-lg animate-float"
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Professional-grade tools and infrastructure trusted by
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative">
          ...
          <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto text-lg">
            Join over 250,000 traders who trust {brokerName || "us"} for their
            investments. Open your free account in minutes.
          </p>
        ...
        <div className="container mx-auto px-6">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <span className="block text-muted-foreground">
                  help@
                  {brokerName?.toLowerCase().replace(/\s/g, "") || "broker"}.com
                </span>
              </div>
            </div>
          </div>
          <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} {brokerName || "Broker"}. All rights
              reserved.
            </p>
