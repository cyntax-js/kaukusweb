...
const AboutPage = () => {
  ...
  const values = [
    {
      ...
      description: 'Enterprise-grade security with cold storage and insurance protection for all assets.',
    },
    {
      icon: Users,
      title: 'Client Focused',
      description: 'Every feature built based on what professional traders actually need.',
    },
    {
      icon: TrendingUp,
      title: 'Innovation',
      description: 'Cutting-edge technology pushing the boundaries of trading infrastructure.',
    },
    {
      icon: Award,
      title: 'Transparency',
  ...
  const milestones = [
    { year: '2020', event: 'Founded with a vision to democratize institutional trading' },
    { year: '2021', event: 'Launched spot trading with 100+ global assets' },
    { year: '2022', event: 'Expanded to futures, options, and derivatives' },
    { year: '2023', event: 'Surpassed 250,000 active traders globally' },
    { year: '2024', event: 'Launched private markets and alternative investments' },
  ];
  ...
  const leadership = [
    { name: 'Executive Team', count: '12', focus: 'Former executives from Goldman Sachs, Morgan Stanley, and Bloomberg' },
    { name: 'Engineering', count: '150+', focus: 'World-class engineers from FAANG and top fintech companies' },
    { name: 'Compliance', count: '25+', focus: 'Regulatory experts ensuring global compliance' },
  ];
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl animate-fade-in stagger-2">
              We're on a mission to give everyone access to institutional-grade trading infrastructure. 
              No compromises on speed, security, or sophistication.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                At {brokerName}, we believe that sophisticated trading tools shouldn't be reserved for Wall Street. 
                We're building technology that empowers individual investors with the same capabilities 
                used by the world's largest institutions.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Every millisecond matters. Every security measure counts. Every feature is designed 
                with one goal: helping you trade with confidence.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {leadership.map((team, index) => (
              ...
              >
                ...
                <div className="text-lg font-semibold text-foreground mb-3">{team.name}</div>
        ...
        <div className="container mx-auto px-6 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to={`${appPrefix}/markets`}>
              <Button size="lg" variant="ghost" className="text-primary-foreground hover:bg-primary-foreground/10 gap-2">
                Explore Markets
                <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              <Link to={`${publicPrefix}/about`} className="text-muted-foreground hover:text-primary transition-colors">About</Link>
              <Link to={`${publicPrefix}/legal`} className="text-muted-foreground hover:text-primary transition-colors">Legal</Link>
            </div>
