...
export const mockBrokerConfigs: BrokerConfig[] = [
  ...
  createBrokerFromPreset('demo-001', 'Demo Trading', 'demo', 'institutional', {
    services: ['spot', 'futures', 'options', 'private_markets'],
  }),
  ...
  createBrokerFromPreset('fbs-001', 'FBS Markets', 'fbs', 'professional', {
    theme: {
      ...
      layout: { auth: 'image-left', dashboard: 'topnav', orderBookPosition: 'left' },
      components: { buttonSize: 'md', borderRadius: 'md', cardStyle: 'bordered' },
    },
  }),
  ...
  createBrokerFromPreset('forexsimple-001', 'Forex Simple', 'forexsimple', 'minimal', {
    services: ['spot'],
  }),
];
